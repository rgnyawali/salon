...
INSERT INTO public.appointments VALUES (2, 6, 2, '5');
...
INSERT INTO public.customers VALUES (6, '555--5555', 'asb');
...
INSERT INTO public.services VALUES (3, 'Kids Haircut');
...
INSERT INTO public.services VALUES (7, 'Hair Shampoo');
INSERT INTO public.services VALUES (8, 'Steam Towel');
...
SELECT pg_catalog.setval('public.appointment_appointment_id_seq', 18, true);
...
ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointment_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointment_service_id_fkey FOREIGN KEY (service_id) REFERENCES public.services(service_id) ON DELETE CASCADE;
